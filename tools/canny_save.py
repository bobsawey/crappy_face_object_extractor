...
cv2.imwrite(f"grab_cut_tests/{ts}.{filename[8:]}.0.auto_canny.png", autocanny_img)
cv2.imwrite(f"grab_cut_tests/{ts}.{filename[8:]}.0.tight_canny.png", tightcanny_img)
cv2.imwrite(f"grab_cut_tests/{ts}.{filename[8:]}.0.wide_canny.png", widecanny_img)
